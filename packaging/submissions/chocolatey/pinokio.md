...
Download the official GitHub release, extract the NSIS wrapper and embedded `app-64.7z` into `$toolsDir\app`, and install a shim only. Do not run the installer.
