# Chocolatey Submission: Voicebox

- Contract: voicebox
- Chocolatey package id: voicebox
- Status: package source implemented; isolated Chocolatey runtime validation pending.
- Track: conductor/tracks/voicebox_20260613/

## No-Admin Strategy

Download the official GitHub release MSI, extract it with 7-Zip into `$toolsDir\app`, and install `voicebox`, `voicebox-server`, and `voicebox-mcp` shims only. Do not execute MSI custom actions.
